...
ACT_ROTATE_CURSOR_PAGE_UP = "ACT_ROTATE_CURSOR_PAGE_UP"
ACT_ROTATE_CURSOR_PAGE_DOWN = "ACT_ROTATE_CURSOR_PAGE_DOWN"
...
PresetKeybinds: KeybindContainer = {
    "right": {
        ...
        ACT_ROTATE_CURSOR_PAGE_UP: ((Alt,), PageUp),
        ACT_ROTATE_CURSOR_PAGE_DOWN: ((Alt,), PageDown),
        ...
        ACT_TOGGLE_WASD_MODE: ((Control,), T),
        ...
        ACT_DESELECT_ALL_BOXES: ((Control, Shift), A),
        ...
        ACT_MOVE_CAMERA_TO_CURSOR: ((Control,), F),
        ACT_TELEPORT_CURSOR_TO_CAMERA: ((Shift, Control), F),
    },
    "left": {
        ACT_MOVE_UP: ((), U),
        ACT_MOVE_DOWN: ((), M),
